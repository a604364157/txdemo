...
public class Lunar {
     ...
     *
     * @param yearLog  year
     * @param monthLog month
     * @param dayLog   day
     * @return str
     */
    public String getLunarDate(int yearLog, int monthLog, int dayLog) {
        ...
        nowadays = yearLog + "年" + monthLog + "月" + dayLog + "日";
        try {
    ...
    public String toString() {
        if ("一".equals(CHINESE_NUMBER[month - 1]) && "初一".equals(getChinaDayString(day))) {
            return "农历" + year + "年";
        } else if ("初一".equals(getChinaDayString(day))) {
            return CHINESE_NUMBER[month - 1] + "月";
        } else {
            return getChinaDayString(day);
        }
